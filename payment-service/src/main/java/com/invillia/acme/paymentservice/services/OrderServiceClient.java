...
import com.invillia.acme.paymentservice.utils.MyThreadLocalsHolder;
...
public class OrderServiceClient {
    ...
    private final OrderServiceFeignClient inventoryServiceFeignClient;
    //TODO; move this to config file
    private static final String INVENTORY_API_PATH = "http://inventory-service/api/";


    @Autowired
    public OrderServiceClient(RestTemplate restTemplate, OrderServiceFeignClient inventoryServiceFeignClient) {
